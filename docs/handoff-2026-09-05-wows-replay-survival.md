...
- `cargo test -p wows-replay-insights --lib`：**142 passed**（含 `plate_thickness_casts_to_the_nearest_plate`、`plate_thickness_prefers_the_impact_plate_over_a_grazed_one`）。

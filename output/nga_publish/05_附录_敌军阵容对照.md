...
> 注2：「未识别单位」 = 船 id 不在玩家船缓存（多为运输船/岸防等特殊单位）。
...
- 友方非玩家：
  - 未识别单位×100、Saipan(T8)×18、Shchors(T7)×20、Fletcher(T9)×20
...
- 敌军：
  ...
  - 未识别单位×21
- 友方非玩家：
  - 未识别单位×70、Saipan(T8)×9、Shchors(T7)×14、Fletcher(T9)×14
...
- 敌军：
  ...
  - 未识别单位×28
- 友方非玩家：
  - 未识别单位×115、Franklin D. Roosevelt(T10)×18、Shchors(T7)×23、Gearing(T10)×23
...
- 敌军：
  ...
  - 未识别单位×8
- 友方非玩家：
  - 未识别单位×15、未识别单位×15、未识别单位×15、未识别单位×15
...
- 敌军：
  ...
  - 未识别单位×21、未识别单位×8
- 友方非玩家：
  - 未识别单位×19、未识别单位×19、未识别单位×19、未识别单位×19
...
- 敌军：
  ...
  - 未识别单位×9、未识别单位×49
- 友方非玩家：
  - 未识别单位×20、未识别单位×20、未识别单位×20、未识别单位×20
...
- 友方非玩家：
  - 未识别单位×36、未识别单位×18、Vanguard(T8)×1、Montana(T10)×1、Ohio(T10)×1、Alaska(T9)×1、Seattle(T9)×1、Des Moines(T10)×13、Mahan(T7)×3、Benson(T8)×3
...
- 敌军：
  ...
  - 未识别单位×9
- 友方非玩家：
  - 未识别单位×38、未识别单位×19、Des Moines(T10)×16、Mahan(T7)×1、Benson(T8)×1
...
- 敌军：
  ...
  - 未识别单位×27
- 友方非玩家：
  - 未识别单位×44、未识别单位×22、Des Moines(T10)×21
...
- 敌军：
  ...
  - 未识别单位×58、未识别单位×29、未识别单位×29、未识别单位×29
- 友方非玩家：
  - 未识别单位×116、未识别单位×29
...
- 友方非玩家：
  - 未识别单位×50、Lexington(T8)×25、Midway(T10)×25、Fletcher(T9)×50
...
- 敌军：
  ...
  - 未识别单位×37
- 友方非玩家：
  - 未识别单位×46、Lexington(T8)×23、Midway(T10)×23、Fletcher(T9)×46
...
- 敌军：
  ...
  - 未识别单位×25
- 友方非玩家：
  - 未识别单位×60、Lexington(T8)×30、Midway(T10)×30、Fletcher(T9)×60

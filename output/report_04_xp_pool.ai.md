...
map_codenames:
  ...
  NavalBase: {name: 防守纽波特, base_bracket: 6-8}
  Labyrinth: {name: 猛禽救援, base_bracket: 6-8}
  Naval_Defense: {name: 赫尔墨斯, base_bracket: 6-8}
  Advance: {name: 最终前线, base_bracket: 6-8}
  Atoll: {name: 纳莱, base_bracket: 6-8}
  LePVE: {name: 杀人鲸, base_bracket: 6-8}
